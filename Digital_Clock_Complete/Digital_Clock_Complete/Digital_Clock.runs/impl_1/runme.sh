...
HD_PWD='D:/Desktop/Digital_Clock_Complete/Digital_Clock_Complete/Digital_Clock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Digital_Clock_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Digital_Clock_wrapper.tcl -notrace

...
HD_PWD='D:/Desktop/Digital_Clock_Complete/Digital_Clock_Complete/Digital_Clock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Digital_Clock_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Digital_Clock_wrapper.tcl

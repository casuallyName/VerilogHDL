...
HD_PWD='D:/Desktop/Digital_Clock_Complete/Digital_Clock_Complete/Digital_Clock.runs/Digital_Clock_Mux2to1_DF_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Digital_Clock_Mux2to1_DF_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Digital_Clock_Mux2to1_DF_0_0.tcl

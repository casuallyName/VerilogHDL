...
HD_PWD='D:/Desktop/Digital_Clock/Digital_Clock.runs/Digital_Clock_cnt24_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Digital_Clock_cnt24_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Digital_Clock_cnt24_0_0.tcl

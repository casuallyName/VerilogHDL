...
HD_PWD='D:/Desktop/Digital_Clock/Digital_Clock.runs/Digital_Clock_display_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Digital_Clock_display_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Digital_Clock_display_0_1.tcl
